...
class KamatasquatTable : AppCompatActivity() {
            ...
            if (extimes <= maxextimes) {
                when (num) {
                    ...
                    2 -> {
                        ...
                        soundPool.play(sndkeep5, countVolume, countVolume, 0, 0, 1.0f)
                    }
                    3 -> soundPool.play(snd1, countVolume, countVolume, 0, 0, 1.0f)
                    4 -> soundPool.play(snd2, countVolume, countVolume, 0, 0, 1.0f)
                    5 -> soundPool.play(snd3, countVolume, countVolume, 0, 0, 1.0f)
                    6 -> soundPool.play(snd4, countVolume, countVolume, 0, 0, 1.0f)
                    7 -> soundPool.play(snd5, countVolume, countVolume, 0, 0, 1.0f)
                    8 -> {
                ...
                speedTime = 1000L
                if (!isSaved) {
                    RecordManager.saveRecord(this@KamatasquatTable, "20${workmenu}")
                    isSaved = true
                }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvexpla.text = "両手をテーブルにのせ、足は肩幅に広げる。" +
        ...
        btnChangeTimes.setOnClickListener {
            val intent2 = Intent(this@KamatasquatTable, MainActivity2::class.java)
        ...
        btnyoutube.setOnClickListener {
            val intent = Intent(this@KamatasquatTable, Youtube::class.java)
            val yID = "https://youtu.be/e9SqQ71tSX4?t=38"
