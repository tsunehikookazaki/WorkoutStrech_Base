...
class ChairSquat : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvexpla.text = "椅子に座り（腰掛ける程度）、両足を肩幅に広げ、ゆっくり立つ。立ち上がったら、ゆっくり（座るイメージで）腰を下ろす。\n膝がつま先より出ないように。背中が曲がらないように。\n\n10回で1セット。1セット標準。"
        ...
        val sounds = listOf(snd1, snd2, snd3, snd4, snd5, snd6, snd7)
        ...
        chronometer.setOnChronometerTickListener {
            ...
            if (extimes <= maxextimes) {
                ...
                btnyoutube.isEnabled = true
                if (!isSaved) {
                    RecordManager.saveRecord(this, "18${workmenu}")
                    isSaved = true
                }
